...
const advanceSchema = new mongoose.Schema(
  {
    ...
    source: { type: String, enum: ['booking', 'driver', 'other'], default: 'other' },
...
const tripSchema = new mongoose.Schema(
  {
    ...
    permitCharges: { type: Number, default: 0, min: 0 },
    ...
    bookingAdvance: { type: Number, default: 0, min: 0 },
    driverAdvance: { type: Number, default: 0, min: 0 },
